...
&&  apk add -U --no-cache jq git bash composer icu-dev jpeg-dev libpng-dev libxpm-dev freetype-dev libxml2-dev curl-dev  libedit-dev libzip-dev zlib-dev libmemcached-dev libxslt-dev pcre-dev openldap-dev zstd-dev
...
RUN docker-php-ext-install gd intl tokenizer xml zip curl opcache ldap soap pdo_mysql mysqli bcmath exif pcntl
